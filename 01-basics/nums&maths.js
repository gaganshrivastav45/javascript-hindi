...
// let num = 1e6
// console.log(num)// large number ko short form mei likh sakte hai 
...
// console.log(Math.sqrt(64)) // square root nikalta hai 
...
// console.log(Math.hypot(3,4))// multiple numbers ka square root of sum of squre nikalta hai 
